...
import scorecardPlugin from '@rhdh-parasol/backstage-plugin-scorecard-backend';
import scorecardFilecheckModule from '@rhdh-parasol/backstage-plugin-scorecard-backend-module-filecheck';
