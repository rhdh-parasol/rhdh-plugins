...
**Install:** `yarn workspace backend add @rhdh-parasol/backstage-plugin-scorecard-backend-module-dependabot` then `backend.add(import('@rhdh-parasol/backstage-plugin-scorecard-backend-module-dependabot'))`.
