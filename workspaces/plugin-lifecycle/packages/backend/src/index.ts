...
// Read the Extensions Catalog Plugin and Package entities using the same
// backend modules used by RHDH. The lifecycle service links these entities to
// the Software Catalog Components; it does not duplicate extension metadata.
backend.add(
